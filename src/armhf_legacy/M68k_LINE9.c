    ...
    if ((opcode & 0x0008) == 0)
    {
        ...
        switch (size)
        {
            case 0: /* Byte */
                ...
                *ptr++ = lsl_immed(tmp_2, regy, 24);
                *ptr++ = sub_cc_immed(ARM_CC_NE, tmp_2, tmp_2, 0x401);
                *ptr++ = subs_reg(tmp_2, tmp_2, tmp, 0);
                *ptr++ = lsr_immed(tmp_2, tmp_2, 24);
                *ptr++ = bfi(regy, tmp_2, 0, 8);
                RA_FreeARMRegister(&ptr, tmp_2);
                RA_FreeARMRegister(&ptr, tmp);
#endif
                break;
            case 1: /* Word */
                ...
                *ptr++ = lsl_immed(tmp_2, regy, 16);
                *ptr++ = sub_cc_immed(ARM_CC_NE, tmp_2, tmp_2, 0x801);
                *ptr++ = subs_reg(tmp_2, tmp_2, tmp, 0);
                *ptr++ = lsr_immed(tmp_2, tmp_2, 16);
                *ptr++ = bfi(regy, tmp_2, 0, 16);
                RA_FreeARMRegister(&ptr, tmp_2);
                RA_FreeARMRegister(&ptr, tmp);
#endif
                break;
